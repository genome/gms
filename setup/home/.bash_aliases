...
alias gil='genome individual list'
alias giv='genome individual view'
alias gsl='genome sample list'
alias gll='genome library list'
alias gmg='genome model-group'
alias gmgm='genome model-group member'
alias gpp='genome processing-profile'
alias gils='genome instrument-data list solexa'
alias gidls='genome instrument-data list solexa'
alias gmd='genome model define'
alias gmid='genome model instrument-data'
alias gmi='genome model input'
alias gmis='genome model input show'
