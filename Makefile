...
DATASERVER=https://xfer.genome.wustl.edu/gxfer1/project/gms/testdata/GMS1/setup/archive-files
...
GIT_VERSION_UR:=master
GIT_VERSION_GENOME:=gms-pub-testmerge3
GIT_VERSION_WORKFLOW:=gms-pub-testmerge
